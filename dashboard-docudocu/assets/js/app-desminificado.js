// Los elementos de la columna izquierda del menú se introducen en este archivo mediante la función i() en la 
...
!function () {
    ...
    // La siguiente función construye la columna izquierda del menú
    // function i() {
    ...
    //                 e.classList.add("menu-left__item__text");
    //             }),
    ...
    function i() {
        var n, e = document.documentElement.getAttribute("data-layout"),
            t = sessionStorage.getItem("defaultAttribute"),
            t = JSON.parse(t);
        if (t && ("twocolumn" == e || "twocolumn" == t["data-layout"])) {
            ...
            // Hardcodea los elementos del menú aquí
            n.innerHTML = `
            <div class="simplebar-wrapper">
              <div class="simplebar-mask">
               ...
               <a href="#" class="logo"><img src="assets/images/hojita.png" alt="" height="32"></a>
               <li>
                   <a class="nav-icon" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarDashboards">
                       <i class="ri-dashboard-2-line"></i> 
                       <span class="menu-left__item__text">Facturación</span>
                   </a>
               </li>
               <li>
                   <a class="nav-icon" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarApps">
                       <img class="menu-left__item__img" src="assets/images/icons/Finance.svg" alt="Icono facturación">
                       <span class="menu-left__item__text">Contabilidad</span>
                   </a>
               </li>
               <li>
                   <a class="nav-icon" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                       <i class="ri-layout-3-line"></i> 
                       <span class="menu-left__item__text">Proyectos</span>
                       <span class="badge badge-pill bg-danger menu-left__item__text">Comprar</span>
                   </a>
               </li>
               <li>
                   <a class="nav-icon" href="#sidebarForms" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarForms">
                       <i class="ri-file-list-3-line"></i> 
                       <span class="menu-left__item__text">Empleados</span>
                   </a>
               </li>
               <li>
                   <a class="nav-icon" href="#sidebarTables" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTables">
                       <i class="ri-layout-grid-line"></i> 
                       <span class="menu-left__item__text">SAT</span>
                   </a>
               </li>
               <li>
                   <a class="nav-icon" href="#sidebarTables" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTables">
                       <i class="ri-layout-grid-line"></i> 
                       <span class="menu-left__item__text">CRM</span>
                   </a>
               </li>
            </div>
            </div>
           ...
           `;
            ...
            // Funcionalidad de click para los elementos
            Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(function (a) {
                ...
                a.addEventListener("click", function (e) {
                    ...
                    // Condiciones para el cambio de panel y actualización de elementos activos
                    if ((n != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) && document.body.classList.contains("twocolumn-panel")) {
                    ...
                    if ((e.target && e.target.matches("a.nav-icon")) || (e.target && e.target.matches("i"))) {
                        var activeNavIcon = document.querySelector("#two-column-menu ul .nav-icon.active");

                        if (activeNavIcon) {
                            activeNavIcon.classList.remove("active");
                        }

                        // Activar el ícono clicado
                        (e.target.matches("i") ? e.target.closest("a") : e.target).classList.add("active");

                        // Mostrar el ítem correspondiente
                        var activeItem = document.getElementsByClassName("twocolumn-item-show");
                        if (activeItem.length > 0) {
                            activeItem[0].classList.remove("twocolumn-item-show");
                        }

                        // Obtener el ID del ítem
                        var itemID = (e.target.matches("i") ? e.target.closest("a") : e.target).getAttribute("href").slice(1);

                        // Si el ítem existe, añadir la clase show
                        var targetItem = document.getElementById(itemID);
                        if (targetItem) {
                            targetItem.parentElement.classList.add("twocolumn-item-show");
                        }
                    }
                });

                // Comprobar si el enlace está activo
                if (n == "/" + a.getAttribute("href") && !a.getAttribute("data-bs-toggle")) {
    ...
    function c(e) {
        if (e.target && e.target.matches("a.nav-link span")) if (0 == l(e.target.parentElement.nextElementSibling)) {
            ...
            if (1 == l(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth) for (var a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;) a[0].classList.remove("dropdown-custom-right");
        if (e.target && e.target.matches("a.nav-link")) if (0 == l(e.target.nextElementSibling)) {
            ...
            if (1 == l(e.target.nextElementSibling) && 1848 <= window.innerWidth) for (a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;) a[0].classList.remove("dropdown-custom-right")
    }
    function O() {
        var e = document.documentElement.clientWidth;
            ...
            e == a.value ? a.checked = !0 : a.checked = !1,
                a.addEventListener("change", function () {
                    ...
                    "semibox" == document.documentElement.getAttribute("data-layout") && ("hidden" == document.documentElement.getAttribute("data-sidebar-visibility") ? (document.documentElement.removeAttribute("data-sidebar"), document.documentElement.removeAttribute("data-sidebar-image"), document.documentElement.removeAttribute("data-sidebar-size"), t = "none") : (document.documentElement.setAttribute("data-sidebar", sessionStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-sidebar-image", sessionStorage.getItem("data-sidebar-image")), document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")))),
                        ...
                        "data-preloader" == n && "enable" == a.value ? (document.documentElement.setAttribute("data-preloader", "enable"), (e = document.getElementById("preloader")) && setTimeout(function () {
                            e.style.opacity = "0",
                                e.style.visibility = "hidden"
                        },
                            1e3), document.getElementById("customizerclose-btn").click()) : "data-preloader" == n && "disable" == a.value && (document.documentElement.setAttribute("data-preloader", "disable"), document.getElementById("customizerclose-btn").click()),
    ...
    sessionStorage.getItem("defaultAttribute") ? ((f = {})["data-layout"] = sessionStorage.getItem("data-layout"), f["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), f["data-bs-theme"] = sessionStorage.getItem("data-bs-theme"), f["data-layout-width"] = sessionStorage.getItem("data-layout-width"), f["data-sidebar"] = sessionStorage.getItem("data-sidebar"), f["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), f["data-layout-position"] = sessionStorage.getItem("data-layout-position"), f["data-layout-style"] = sessionStorage.getItem("data-layout-style"), f["data-topbar"] = sessionStorage.getItem("data-topbar"), f["data-preloader"] = sessionStorage.getItem("data-preloader"), f["data-body-image"] = sessionStorage.getItem("data-body-image"), e(f)) : (L = document.documentElement.attributes, f = {},
        ...
        D(),
        r(),
        document.getElementsByClassName("dropdown-item-cart") && (k = document.querySelectorAll(".dropdown-item-cart").length, Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function (e) {
            e.addEventListener("click", function (e) {
                k--,
